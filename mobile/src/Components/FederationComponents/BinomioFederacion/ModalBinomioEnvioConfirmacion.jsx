...
const ModalBinomioEnvioConfirmacion = ({modalEnvioConfirmacion, setModalEnvioConfirmacion, receptorCredencial, caballo, jinete, setSteps}) => {
...
export default ModalBinomioEnvioConfirmacion