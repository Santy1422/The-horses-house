...
const ModalPasaporteChip = ({modalVisible, setModalVisible, receptorCredencial, setReceptorCredencial, setModalEnvioDatos, caballo}) => {
...
export default ModalPasaporteChip