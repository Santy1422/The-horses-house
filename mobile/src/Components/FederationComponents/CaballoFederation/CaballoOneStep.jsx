...
import ModalPasaporteChip from "./ModalPasaporteChip"
import ModalEnvio from "./ModalEnvio";
import ModalEnvioConfirmacion from "./ModalEnvioConfirmacion";
...
export const CaballoOneStep = ({setSteps, caballo, setCaballo, jinete, numeroCelular, setNumeroCelular, receptorCredencial, setReceptorCredencial }) => {
        ...
        <LinearGradient colors={['#F0F0F8', '#FFFFFF']} className="main w-full">
            ...
            <ScrollView className="h-full">
                <View className="contenedorForm flex flex-col px-6">
                    ...
                    <Text className="caballo font-latoBold text-2xl leading-8 text-[#23254C] mt-[27]">Caballo</Text>                    
                    ...
                    <ModalPasaporteChip modalVisible={modalVisible} setModalVisible={setModalVisible} receptorCredencial={receptorCredencial} setReceptorCredencial={setReceptorCredencial} setModalEnvioDatos={setModalEnvioDatos} setSteps={setSteps} caballo={caballo}/>    
                    <ModalEnvio modalEnvioDatos={modalEnvioDatos} setModalEnvioDatos={setModalEnvioDatos} receptorCredencial={receptorCredencial} setReceptorCredencial={setReceptorCredencial} setModalVisible={setModalVisible} setModalEnvioConfirmacion={setModalEnvioConfirmacion}/>
                    <ModalEnvioConfirmacion setModalEnvioConfirmacion={setModalEnvioConfirmacion} modalEnvioConfirmacion={modalEnvioConfirmacion} caballo={caballo} receptorCredencial={receptorCredencial}/>
                </View>
            </ScrollView>
        </LinearGradient>
    )
