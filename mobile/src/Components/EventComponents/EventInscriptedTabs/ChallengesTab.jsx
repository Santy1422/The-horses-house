...
export const ChallengesTab = ({ pruebas }) => {
        ...
        <>
            {
                pruebas?.map((prueba, i) => {
                    return (
                        <ContentCard icon key={i} title={`Prueba ${prueba.nombre}`} dropdown isOpenValue={isOpen} value={prueba.nombre} onPress={() => handleIsOpen(prueba.nombre)} >
                            {isOpen.includes(prueba.nombre) && <>

                                <View className="flex-row self-stretch justify-between h-[72px] bg-white">
                                    <View className="justify-center">
                                        <Text className="text-zinc-700 text-xs font-latoRegular">Binomio a competir</Text>
                                        <Text className="text-labelDarkBlue text-sm font-latoRegular">Marcos Defensa</Text>
                                        <Text className="text-labelDarkBlue text-sm font-latoRegular">XL DER HEAT</Text>
                                    </View>
                                    <View className="flex-row items-center">
                                        <Image className="relative left-[15] rounded-full w-[46px] h-[46px]" source={require('../../../images/Avatar.png')} />
                                        <Image className="rounded-full w-[46px] h-[46px]" source={require('../../../../assets/horsePP.png')} />
                                    </View>
                                </View>
                                ...
                                <View className="flex-row self-stretch justify-between h-[72px] bg-white rounded">
                                    <View className="justify-center p-4">
                                        <Text className="text-zinc-700 text-sm font-latoRegular">Categoría</Text>
                                    </View>
                                    <View className="justify-center max-w-[170] p-4">
                                        <Text className="text-zinc-700 text-xs font-latoRegular">{prueba.categoria.join(', ')}</Text>
                                    </View>
                                </View>
                                <View className="flex-row self-stretch justify-between h-[72px] bg-zinc-100 rounded">
                                    <View className="justify-center p-4">
                                        <Text className="text-zinc-700 text-sm font-latoRegular">Altura</Text>
                                    </View>
                                    <View className="justify-center p-4">
                                        <Text className="text-zinc-700 text-xs font-latoRegular">{prueba.altura}</Text>
                                    </View>
                                </View>
                                <View className="flex-row self-stretch justify-between h-[72px] bg-white rounded">
                                    <View className="justify-center p-4">
                                        <Text className="text-zinc-700 text-sm font-latoRegular">Definición</Text>
                                    </View>
                                    <View className="justify-center p-4">
                                        <Text className="text-zinc-700 text-xs font-latoRegular">{prueba.definicion}</Text>
                                    </View>
                                </View>
                                <View className="flex-row self-stretch justify-between h-[72px] bg-zinc-100 rounded">
                                    <View className="justify-center p-4">
                                        <Text className="text-zinc-700 text-sm font-latoRegular">Arancel</Text>
                                    </View>
                                    <View className="justify-center p-4">
                                        <Text className="text-zinc-700 text-xs font-latoRegular">$ {prueba.arancelInscripcion}</Text>
                                    </View>
                                </View>
                                <View className="flex-row self-stretch justify-between h-[72px] bg-white rounded">
                                    <View className="justify-center p-4">
                                        <Text className="text-zinc-700 text-sm font-latoRegular">Pista</Text>
                                    </View>
                                    <View className="justify-center p-4">
                                        <Text className="text-zinc-700 text-xs font-latoRegular">"A"</Text>
                                    </View>
                                </View>
                                <View className="flex-row self-stretch justify-between h-[72px] bg-zinc-100 rounded">
                                    <View className="justify-center p-4">
                                        <Text className="text-zinc-700 text-sm font-latoRegular">Premio</Text>
                                    </View>
                                    <View className="justify-center p-4">
                                        <Text className="text-zinc-700 text-xs font-latoRegular">Doble de la inscripción</Text>
                                    </View>
                                </View>
                            </>}
                        </ContentCard>
