...
const EmailInput = ({ setValue, label, value = "" }) => {
  ...
  return (
    <div className={`flex flex-col w-full items-start gap-1.5`}>
      <label className={`w-full h-5 ${styles["text-font-lato"]} text-base font-normal leading-6 text-[#23254C]`}>
        {label}
      </label>
      <div
      ...
      >
        ...
        <input
          ...
          className={`w-full outline-0 ${styles["text-font-lato"]} text-base`}
      ...
      {error && (
        <span className={`w-full h-4 text-sm font-light leading-6 ${styles["text-font-lato"]} text-red-500`}>
          {error}
        </span>
      )}  
      {hint && !error && (
        <span className={`w-full h-4 text-sm font-light leading-6 ${styles["text-font-lato"]} text-gray-400 ${visible}`}>
          {hint}
        </span>
      )}
    </div>
