...
export const Login = () => {
    ...
    console.log('loadingAuth', loadingAuth.usuarioAuth)
                ...
                <>
                    ...
                    <div className={`flex flex-row-reverse h-screen w-screen ${styles["login-desktop"]}`}>
                        ...
                        <div className={`flex flex-grow ${styles["login-form-container"]} justify-center`} style={{ overflowY: 'scroll' }}>
                            <div className="p-5  w-full max-w-[327px] gap-y-[16px] h-full flex flex-col justify-start items-center">
                                <div className="mt-10 mb-5"><Logo size="large" /></div>


                                <div className={`text-center text-indigo-950 text-2xl font-semibold ${styles["text-font-lato"]}`}>Iniciá sesión con tu cuenta</div>
                                ...
                                <div className=" flex gap-1 w-full justify-center pb-4">
                                    ...
                                    <Link href="/register/registerOnboarding">  <div className={`w-[107px] h-5 text-blue-950 text-base font-bold ${styles["text-font-lato"]} hover:cursor-pointer`}>Registrarse</div></Link>
                                </div>
                            </div>
                    ...
                    <div className={`w-full flex flex-col items-center ${styles["login-mobile"]}`}>
                        ...
                        <div className={`w-full h-full flex justify-center ${styles['login-background-img']}`}>
                            <div className={`relative top-[107px] flex w-full max-w-[327px] py-[24px] px-[18px] flex-col items-center gap-y-[20px] rounded-[10px] shadow ${styles["login-form-container"]}`}>
                                ...
                                <div className={`text-center text-indigo-950 text-lg font-bold ${styles["text-font-lato"]}`}>Iniciá sesión con tu cuenta</div>
                        ...
                        <div className="flex flex-col w-full max-w-[327px]">
                            ...
                            <div className=" flex gap-1 w-full justify-center pb-4">
                                ...
                                <Link href="/register/registerOnboarding">  <div className={`w-[107px] h-5 text-blue-950 text-sm font-bold ${styles["text-font-lato"]} hover:cursor-pointer`}>Registrarse</div></Link>
                            </div>
                        </div>
                    </div>
                </>
