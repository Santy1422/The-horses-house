...
const HourInput = ({ setValue, label, hintEditable }) => {
  ...
  return (
    <div className={`flex flex-col w-full items-start gap-1.5`}>
      ...
      <div className={`flex h-11 px-3.5 py-2.5 bg-white border rounded items-center gap-2   w-full ${divBlue ? "border-blue-300" : 'border-gray-300'} ${error ? "border-red-300" : time ? 'border-green-300' : ''} `}>
        {!divBlue && 
